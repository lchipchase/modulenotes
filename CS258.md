...
- When an entity is deleted, all information about the entities referred to that could also be deleted
...
- Discretionary access control is an all or nothing approach
