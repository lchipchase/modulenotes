...
- two subclasses, PreparedStatment, CallableStatement
...
## Advanced SQL - Multi Table Queries

### Cross Join

- Specifying > 1 table in the FROM vlause
- Need to understand the implication sof having more than one table
- The operational semantics chane
  - With 1 sable from FROM, we scan the table 1 tuple at a time
  - Whit > 1, we can think of ocmputing the cartesian product of the tables whihc produces a new one
