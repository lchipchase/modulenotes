...
- Since each matching augmentation increase the size of the matchign and since any matching willhave size $\leq \lfloor n/2\rfloor$, we will need at most $\lfloor n/2\rfloor$ augmentations
